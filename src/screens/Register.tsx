            ...
            <ScrollView className="container mx-auto px-4 pt-4 pl-6 pr-6">
                ...
                <Animated.View entering={FadeInDown.delay(50).duration(500).springify()}>
                    ...
                    {errors.birthday ? (
                        ...
                        <BaseText className="text-xs text-[#8B8DA5] pt-1 pl-1 pb-1">
                            To signup, you must be 16 or older
                        </BaseText>
                    ) : null}
                    <DatePicker
                        mode="date"
                    ...
                    {errors.password ? (
                        ...
                        <BaseText className="text-xs text-[#8B8DA5] pt-1 pl-1 pb-1">
                            Password must contain an uppercase character, at least 6 characters
                            long.
                        </BaseText>
                    ) : null}

                    <BaseText className="text-xs text-[#8B8DA5] pt-5 pl-1 pb-1">
                        By selecting Agree and continue, I agree to HealthE's Terms and conditions
